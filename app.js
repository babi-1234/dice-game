// Тоглоомийн бүх газар ашиглагдах глобаль хувьсагчдыг энд зарлая
...
document.querySelector(".btn-roll").addEventListener("click", function () {
  if (isNewGame) {
    ...
    alert("Togloom duussan bna. NEW GAME tovchiig darj shineer eheluulne uu");
  }
});
...
document.querySelector(".btn-hold").addEventListener("click", function () {
  if (isNewGame) {
    ...
    // Уг тоглогч хожсон (оноо нь 100-с их эсэх) эсэхийг шалгах
...
// Энэ функц нь тоглох ээлжийг дараачийн тоглогч руу шилжүүлэх
